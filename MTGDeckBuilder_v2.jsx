...
const MTGDeckBuilder = () => {
  ...
  // Process card text (used by both file upload and paste)
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-gray-800 bg-opacity-50 backdrop-blur rounded-lg p-6 mb-6 border border-gray-700">
          ...
          <div className="mb-6 pb-6 border-b border-gray-600">
            <h3 className="text-sm font-semibold text-purple-300 mb-2">Option 1: Upload File</h3>
          ...
          {/* Paste Area */}
          <div>
            <h3 className="text-sm font-semibold text-purple-300 mb-2">Option 2: Copy & Paste</h3>
            <textarea
              value={pasteText}
        ...
        {filteredCards.length === 0 && (
          <div className="text-center py-12">
            <p className="text-gray-400">No cards yet. Upload or paste your card list to get started!</p>
          </div>
        )}
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-3">
                {chatMessages.length === 0 ? (
                  <div className="text-gray-400 text-sm text-center py-8">
                    ...
                    <p className="text-xs">"What cards go with Lightning Bolt?"</p>
                    <p className="text-xs">"Build me a Commander deck"</p>
                  </div>
                ) : (
